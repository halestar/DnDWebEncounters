                        ...
                        <div class="card-body">
                            <div class="alert alert-info mb-3">
                                <div class="form-check-inline">
                                    <input type="radio" name="player_type" id="player_type_existing"
                                           class="form-check-input" value="EXISTING" checked
                                           onclick="jQuery('#existing_player_container').show();jQuery('#new_player_container').hide();">
                                    <label for="player_type_existing" class="form-check-label">Existing Player</label>
                                </div>
                                <div class="form-check-inline">
                                    <input type="radio" name="player_type" id="player_type_new" class="form-check-input"
                                           value="NEW"
                                           onclick="jQuery('#existing_player_container').hide();jQuery('#new_player_container').show();">
