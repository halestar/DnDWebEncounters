...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8" id="help">
            <h1 class="text-center">D&amp;D Encounters Tutorial</h1>
            <h2>Introduction</h2>
            ...
            <p class="text-justify">
                ...
                This is not an app to manage all aspects of encounters. Nor is it an information-heavy app that allows you track all encounter variables.
                Rather this was built with the idea that it should be as lightweight as possible, aiding the DM in the encounter by entering the least
            ...
            <p class="text-justify">
                It also has some simple tools to aid in looking up information, such as a simple spell lookup. All of these tools are made with the idea that the DM
                already has a lot to track, so it should avoid tracking unnecessary data for it's own sake.
            </p>
            <h2>Your Dashboard</h2>
            <p class="text-justify">
                When you first login to D&amp;D Encounters, you will see your Dashboard.  From here you can access all the data that needs to be
                entered in order to begin your encounter, as well as actually begin an encounter.  Before you can start running encounters, however,
                you will need to enter some basic data.
            </p>
            <p class="text-justify">
                Your Dashboard (as seen below) has 3 different areas: The Inventory, the Main Menu and the On-Going adventures.
            </p>
            ...
            <h2>Inventory</h2>
            <p class="text-justify">
                Listed here will be a summary of all the information that you have entered into the system in order to run an encounter.  Only a
                few of these items are necessary to begin playing an adventure, while the others are there as extra resources.  To the right
                of each item will be a number of entries for that item.  For example, a number "4" next to the Players items will mean that
                you have entered 4 Players into your system.  If you see a red alert below an item, it means that you will need to enter at least
            ...
            <dl class="row">
                ...
                <dd class="col-lg-10">
                    Number of <strong>Player Characters</strong> (PC's) entered.  A PC is the actual Character that a Player plays.  Each PC
                ...
                <dd class="col-lg-10">
                    An Encounter is a set of Monsters, both SR and Custom, that will appear in a D&amp;D Encounter.  Most modules have encounters listed, which you can define
            ...
            <p class="text-justify">
                The <span class="text-primary fa fa-plus"></span> at the top is used to enter new Players.  Entering a new player will require only the player name, although
            ...
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/player_add.png" class="figure-img img-fluid rounded" alt="Add New Player View">
            ...
            <p class="text-justify">
                From the list of players you have a small control panel to the right of each player.  The first icon <span class="text-primary fa fa-edit"></span>
                will allow you to update your player information.  The <span class="text-danger fa fa-trash"></span> will allow you to delete the player entry.  <strong>Deleting
                the player entry will also delete all the PC's associated with that player</strong>, so be careful about deleting.  Finally, the <span class="text-info fa fa-eye"></span>
            ...
            <p class="text-justify">
                The <span class="text-primary fa fa-plus"></span> at the top is used to enter new PC, while the filtering dropdown will contain a list of all the Players in your
                system.  Selecting a player from the dropdown will filter the list so that only PC's attached to that Player appear.  Adding a new PC will take you to the
                the section to add a new PC:
            </p>
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/new_pc_existing.png" class="figure-img img-fluid rounded" alt="Add New PC View">
            ...
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/new_pc_new.png" class="figure-img img-fluid rounded" alt="New Player for the New PC View">
            ...
            <p class="text-justify">
                From the PC list, you can also choose to update the PC, by clicking on the <span class="text-primary fa fa-edit"></span> icon for that PC, or to
                completely remove the PC by clicking on the <span class="text-danger fa fa-trash"></span> icon.  Once removed, there is no way to get the PC back!
            </p>
            <h3>Monsters Menu</h3>
            <p class="text-justify">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/custom_monsters.png" class="figure-img img-fluid rounded" alt="Custom Monsters Tab">
                        <figcaption class="figure-caption">List of all custom monsters</figcaption>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/sr_monsters.png" class="figure-img img-fluid rounded" alt="SR Monsters Tab">
            ...
            <p class="text-justify">
                ...
                Custom Monsters is done the same way as Players or PC's.  Click on the <span class="text-primary fa fa-plus"></span> icon at the top
                to add a new one, the <span class="text-primary fa fa-edit"></span> icon next to the monster to wish to change to update that monster,
                and <span class="text-danger fa fa-trash"></span> icon will remove that monster from your account.  Once removed, all mentions of this
                monster on encounters and modules will be removed as well.
            </p>
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/new_custom_monster.png" class="figure-img img-fluid rounded" alt="Adding a Custom Monster">
            ...
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/sr_monster_template.png" class="figure-img img-fluid rounded" alt="SR Monster View">
            ...
            <p class="text-justify">
                ...
                encounter.  This page is very similar in functionality to the Players and PC page. Click on the <span class="text-primary fa fa-plus"></span> icon at the top
                to add a new encounter, the <span class="text-primary fa fa-edit"></span> icon next to the encounter to wish to change to update that encounter,
                and <span class="text-danger fa fa-trash"></span> icon will remove that encounter from your account.  Once removed, all mentions of this
            ...
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/add_encounter.png" class="figure-img img-fluid rounded" alt="Adding an Encounter View">
            ...
            <p class="text-justify">
                ...
                <span class="text-danger fa fa-trash"></span> next to the monster you wish to remove), or to duplicate the monster.  You can duplicate
                the monster by clicking on the <span class="text-primary fa fa-copy"></span> icon.  This will add another of that type of monster to the
            ...
            <div class="row">
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/add_number_token.png" class="figure-img img-fluid rounded" alt="Number Token">
                        <figcaption class="figure-caption">Adding a number token</figcaption>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/add_color_token.png" class="figure-img img-fluid rounded" alt="Color Token">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/add_colored_number_token.png" class="figure-img img-fluid rounded" alt="Colored Number Token">
                        <figcaption class="figure-caption">Adding a colored number token</figcaption>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/mini_token.png" class="figure-img img-fluid rounded" alt="Mini Token">
            ...
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/dashboard_ready.png" class="figure-img img-fluid rounded" alt="Dashboard View">
            ...
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/adventure_setup.png" class="figure-img img-fluid rounded" alt="Adventure Setup View">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/adventure_party.png" class="figure-img img-fluid rounded" alt="Adventure Party View">
                        <figcaption class="figure-caption">Adventuring party setup</figcaption>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/create_new_party.png" class="figure-img img-fluid rounded" alt="Create Party View">
                        <figcaption class="figure-caption">Creating a New Party</figcaption>
                    </figure>
                </div>
            </div>
            <p class="text-justify">
                You <strong>must</strong> assign a party name and select at least one member of the PC's to add to the party.  Once you create the party it
                will be assigned to the adventure.  You can always click the <span class="text-primary fa fa-edit"></span> icon to edit it.
            </p>
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/party_created.png" class="figure-img img-fluid rounded" alt="Create Party View">
            ...
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/current_encounter.png" class="figure-img img-fluid rounded" alt="Quick Encounter View">
            ...
            <p class="text-justify">
                ...
                up as many encounters as you wish this way and then play them in any order by clicking the <span class="text-primary fa fa-play"></span> icon next
                to the encounter you want to play.  For this example, we will be playing one of the queued encounters.
            </p>
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/adventure_setup_done.png" class="figure-img img-fluid rounded" alt="Adventure Setup View">
                <figcaption class="figure-caption">A completed, ready to play adventure</figcaption>
            </figure>
            <h3>Setting Up the Encounter</h3>
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/encounter_setup.png" class="figure-img img-fluid rounded" alt="Encounter Setup View">
            ...
            <p class="text-justify">
                ...
                ask your players to roll and record them under each of their PC's name.  The middle section assigns tokens to monsters.  The system <strong>will</strong>
            ...
            <p class="text-justify">
                The right-most and final sections are special options that you can set up for your encounter.  The <strong>Assign Individual Monster Initiative</strong>
                option rolls initiative for each monster individually, instead of group initiative.  The <strong>Roll for Each Monster's HP</strong> option actually
                assigns random hit points to each monster based on a hit die roll, instead of using the suggested, average value.  Once yopur encounter is set up, we are
                ready to begin.  Ontinue by pushing the "Complete Setup" button at the bottom.
            </p>
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/encounter_setup_complete.png" class="figure-img img-fluid rounded" alt="Encounter Setup View">
                <figcaption class="figure-caption">An encounter completely set up and ready to start.</figcaption>
            </figure>
            <h3>Running the Encounter</h3>
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/encounter_run1.png" class="figure-img img-fluid rounded" alt="Encounter Run View">
            ...
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/encounter_info.png" class="figure-img img-fluid rounded" alt="Encounter Info View">
                <figcaption class="figure-caption">Start of the encounter current state</figcaption>
            </figure>
            <p class="text-justify">
                Immediate, you can glean some very important information from this section.  You can see the flow of initiative since the players and monsters
            ...
            <p class="text-justify">
                <strong>An important note about initiative ties</strong>.  Sometimes players and monsters tie for initiative.  This is more
                ...
                you may want to tweak the initiative ties position.  To do this, there is a special, <strong>hidden</strong> variable called position.
                ...
                monster name or the <span class="text-danger fa fa-edit"></span> icon at the top, and changing the position for that monster to 2.  This
            ...
            <div class="row">
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/edit_party.png" class="figure-img img-fluid rounded" alt="Edit Adventure Party View">
                        <figcaption class="figure-caption">Changing adventuring party information</figcaption>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/edit_encounter_monsters.png" class="figure-img img-fluid rounded" alt="Edit Adventure Encounter View">
            ...
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/encounter_turn.png" class="figure-img img-fluid rounded" alt="Encounter Turn View">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/encounter_turn1_target.png" class="figure-img img-fluid rounded" alt="Monster Target View">
                        <figcaption class="figure-caption">Monster target basic information</figcaption>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/encounter_turn1_monster_abilities.png" class="figure-img img-fluid rounded" alt="Monster Target View (Bottom)">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/monster_hp_controls.png" class="figure-img img-fluid rounded" alt="Monster Hit Point Control View">
                        <figcaption class="figure-caption">Monster hit point control</figcaption>
                    </figure>
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/dire_roll.png" class="figure-img img-fluid rounded" alt="Monster Ability Roll">
                        <figcaption class="figure-caption">Rolling damage on a monster ability</figcaption>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/encounter_turn1_monster_abilities.png" class="figure-img img-fluid rounded" alt="Monster Abilities View">
                        <figcaption class="figure-caption">Monster target abilities</figcaption>
                    </figure>
                </div>
            </div>
            ...
            <p class="text-justify">
                The hit points are <strong>not</strong> updated, however, until you make a decision.  If you click on the "Finish with Monster" button, the monster target will
            ...
            <div class="row">
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/encounter_turn1_end.png" class="figure-img img-fluid rounded" alt="Encounter Turn View">
                        <figcaption class="figure-caption">Player turn ready to end</figcaption>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/encounter_turn2.png" class="figure-img img-fluid rounded" alt="Encounter Turn View">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/end_1st_turn.png" class="figure-img img-fluid rounded" alt="End of Turn View">
                        <figcaption class="figure-caption">Everyone has gone, time for the next turn</figcaption>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/start_2nd_turn.png" class="figure-img img-fluid rounded" alt="Start of Next Turn View">
            ...
            <figure class="figure align-content-md-center">
                <img src="/img/tutorial/encounter_over_next.png" class="figure-img img-fluid rounded" alt="Adventure View">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/dashboard_3.png" class="figure-img img-fluid rounded" alt="Dashboard View">
                        <figcaption class="figure-caption">Dashboard ready to continue last adventure</figcaption>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/dashboard_4.png" class="figure-img img-fluid rounded" alt="Dashboard View">
                        <figcaption class="figure-caption">Dashboard ready to continue the last 2 adventures.</figcaption>
                    </figure>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/die_roller.png" class="figure-img img-fluid rounded" alt="Dice Roller View">
                        <figcaption class="figure-caption">Ready to roll some dice!</figcaption>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/die_roll_results.png" class="figure-img img-fluid rounded" alt="Dashboard View">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/spell_search.png" class="figure-img img-fluid rounded" alt="Spell Search View">
                        <figcaption class="figure-caption">Search for any spells in the Player's Handbook</figcaption>
                    </figure>
                </div>
                <div class="col-sm-6">
                    <figure class="figure align-content-md-center">
                        <img src="/img/tutorial/spell_view.png" class="figure-img img-fluid rounded" alt="Spell View">
