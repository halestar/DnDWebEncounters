                                    ...
                                    <li class="list-group-item p-1" actor_id="{{ $actor->id }}">
                                        <div class="row">
                                            <div class="monster-info col col-9">
                                                ...
                                                <div class="input-group mb-2 ml-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                           id="initiative_{{ $actor->id }}"
                                                           name="initiative_{{ $actor->id }}"
                                                ...
                                                <div class="input-group mb-2 ml-2">
                                                    ...
                                                    <input type="text" class="form-control" id="hp_{{ $actor->id }}"
                                                           name="hp_{{ $actor->id }}" value="{{ $actor->current_hp }}">
                                                </div>
                                                <div class="input-group mb-2 ml-2">
                                                    <div class="input-group-prepend">
                                            ...
                                            <div class="monster-controls text-right m-l col col-3">
                                                <input type="hidden" name="remove_{{ $actor->id }}"
                                                       id="remove_{{ $actor->id }}" value="0"/>
                                                <button
                                                    type="button"
                                                ...
                                                <br>
                                                <input type="hidden" name="dead_{{ $actor->id }}"
                                                       id="dead_{{ $actor->id }}"
                                                ...
                                                <br>
                                                <input type="hidden" name="acted_{{ $actor->id }}"
                                                       id="acted_{{ $actor->id }}"
                                                ...
                                                <br>
                                                <img
                                                    src="{{ route('monster_tokens.show', ['id' => $actor->token_id]) }}"
                                                    class="img-thumbnail ml-3"
                                                    id="token_monster_thumb_{{ $actor->id }}">
                                            </div>
                                        </div>
                                    </li>
                                @endforeach
