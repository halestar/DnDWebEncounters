...
@section('content')
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="col-8">
                <form action="{{ route('play.monster.update', ['adventure_encounter' => $adventureEncounter->id, 'actor_id' => $actor->id]) }}" method="POST">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center" actor_id="{{ $actor->id }}">
                                    <div class="monster-info">
                                        ...
                                        <div class="input-group mb-2 ml-2">
                                            ...
                                            <input type="text" class="form-control" id="initiative" name="initiative" value="{{ $actor->initiative }}">
                                        </div>
                                        <div class="input-group mb-2 ml-2">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">Initiative Position: </div>
                                            </div>
                                            <input type="text" class="form-control" id="initiative_pos" name="initiative_pos" value="{{ $actor->initiative_pos }}">
                                        </div>
                                        <div class="input-group mb-2 ml-2">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">HP: </div>
                                            </div>
                                            <input type="text" class="form-control" id="hp" name="hp" value="{{ $actor->current_hp }}">
                                        </div>
                                        <div class="input-group mb-2 ml-2">
                                            <div class="input-group-prepend">
                                    ...
                                    <div class="monster-controls text-right">
                                        <input type="hidden" name="dead" id="dead" value="{{ $actor->isAlive()? '0': '1' }}" />
                                        <button
                                                type="button"
                                                @if($actor->isAlive())
                                        ...
                                        <br>
                                        <input type="hidden" name="acted" id="acted" value="{{ $actor->has_acted? '1': '0' }}" />
                                        <button
                                                type="button"
                                                @if(!$actor->has_acted)
                                                class="btn btn-success mb-2"
                                        ...
                                        <br>
                                        <img src="{{ route('monster_tokens.show', ['id' => $actor->token_id]) }}" class="img-thumbnail ml-3" id="token_monster_thumb">
                                    </div>
                                </li>
                            </ul>
                        </div>
